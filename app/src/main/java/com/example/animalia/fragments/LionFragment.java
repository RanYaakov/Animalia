...
public class LionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lion, container, false);
        ...
        commentText=view.findViewById(R.id.write_comment_lion);
        btnSend=view.findViewById(R.id.btn_send_lion);
        recyclerView= view.findViewById(R.id.lion_comments);
    ...
    private void loadComments()
    {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Comments").child("Lion");
